...
<html>
    ...
    <div id="formulaire-comment">
            ...
            <form action="?action=chapitre&billetSlug=<?php echo $billet->getSlug();?>" method="post">
                ...
                <button type="submit" value="submit"><a href="?action=chapitre&billetSlug=<?php echo $billet->getSlug();?>"></a>Envoyer</button>
            </form>
    </div>
    <div id="comments">
        <h3>Commentaires</h3>
        ...
        <?php foreach($commentaires as $commentaire){ ?>
                ...
                <small>
                    <a href="?action=chapitre&billetSlug=<?php echo $billet->getSlug();?>&signalComment=<?php echo $commentaire->getId();?>">Signaler</a>
                </small>
